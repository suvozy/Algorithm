...
awf_Form_.AWFormGenerator = function(properties) {
    ...
    this.initialize = function() {
        ...
        var form = document.getElementById('af-form-'+this.id);
        this.resizePopUp();
    ...
    this.fadeDiv = function() {
        ...
        if (this.curOpacity < 100) {
            ...
            if (typeof this.overlay != 'undefined') {
                this.overlay.style.MozOpacity = (this.curOpacity/100)*.8;
                if (this.IE) {
                    this.overlay.style.filter = 'alpha(opacity='+(0.8*this.curOpacity)+')';
                } else {
                    this.overlay.style.MozOpacity = (this.curOpacity/100)*.8;
                    this.overlay.style.opacity = (this.curOpacity/100)*.8;
                }
            }
    ...
    this.showShadow = function() {
        ...
        if (!this.IE6) {
            ...
            this.shadow.style.height = (parseInt(this.height))+'px';
