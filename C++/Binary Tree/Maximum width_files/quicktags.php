...
edButtons[edButtons.length] = new edButton('ed_strong', 'b', '<strong>', '</strong>', 'b');edButtons[edButtons.length] = new edButton('ed_em', 'i', '<em>', '</em>', 'i');edButtons[edButtons.length] = new edButton('ed_del', 'del', '<del>', '</del>', 'd');edButtons[edButtons.length] = new edButton('ed_link', 'link', '', '</a>', 'a');edButtons[edButtons.length] = new edButton('ed_block', 'b-quote', '<blockquote>', '</blockquote>', 'q');edButtons[edButtons.length] = new edButton('ed_code', 'code', '[sourcecode language="c"]', '[/sourcecode]', 'c');edButtons[edButtons.length] = new edButton('ed_close', 'Close Tags', '', '', '');
